...
function initMap() {
    ...
    for (ville in villes) {
        var marker = L.marker([villes[ville].latitude, villes[ville].longitude]).addTo(macarte);

        //description pour la popup de chaque marqueur
        var description = obj.nom + "<br/>" + obj.adresse + "<br/>" + obj.code_postal + "<br/>" + obj.ville + "<br/>" + obj.tel + "<br/>" + obj.email + "<br/>" + obj.site_web + "<br/>" + obj.porteur + "<br/>"; 
